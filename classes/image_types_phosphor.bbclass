...
python do_generate_mmc_ext4() {
    ...
    rofs_a_offset = 0
    rofs_b_offset = int(d.getVar('MMC_ROFS_A_SIZE', True))
    rwfs_offset = rofs_b_offset + int(d.getVar('MMC_ROFS_B_SIZE', True))
    other_offset = rwfs_offset + int(d.getVar('MMC_RWFS_SIZE', True))
    ...
    def get_sectors(size_kb):
        sector_size = 512
        return size_kb * 1024 // sector_size
    ...
    with open(env_file, 'w') as fd:
        fd.write('BOOT_OFFSET={}\n'.format(hex(boot_offset * 1024)))
        fd.write('ROFS_A_OFFSET={}\n'.format(hex((boot_offset + boot_size + rofs_a_offset) * 1024)))
        fd.write('ROFS_B_OFFSET={}\n'.format(hex((boot_offset + boot_size + rofs_b_offset) * 1024)))
        fd.write('RWFS_OFFSET={}\n'.format(hex((boot_offset + boot_size + rwfs_offset) * 1024)))
        fd.write('OTHER_OFFSET={}\n'.format(hex((boot_offset + boot_size + other_offset) * 1024)))
        fd.write('ROFS_A_SIZE_SECTORS={}\n'.format(get_sectors(int(d.getVar('MMC_ROFS_A_SIZE', True)))))
        fd.write('ROFS_B_SIZE_SECTORS={}\n'.format(get_sectors(int(d.getVar('MMC_ROFS_B_SIZE', True)))))
        fd.write('RWFS_SIZE_SECTORS={}\n'.format(get_sectors(int(d.getVar('MMC_RWFS_SIZE', True)))))
        fd.write('OTHER_SIZE_SECTORS={}\n'.format(get_sectors(int(d.getVar('MMC_OTHER_SIZE', True)))))
        fd.write('ROFS_A_DM_OFFSET_SECTORS={}\n'.format(get_sectors(rofs_a_offset)))
        fd.write('ROFS_B_DM_OFFSET_SECTORS={}\n'.format(get_sectors(rofs_b_offset)))
        fd.write('RWFS_DM_OFFSET_SECTORS={}\n'.format(get_sectors(rwfs_offset)))
        fd.write('OTHER_DM_OFFSET_SECTORS={}\n'.format(get_sectors(other_offset)))
