...
do_generate_ext4_tar() {
	# Compression parameters for zstd taken from classes/image_types.bbclass
	zstd -f -k -T0 -c -3 ${IMGDEPLOYDIR}/${IMAGE_LINK_NAME}.${FLASH_EXT4_BASETYPE} > ${IMGDEPLOYDIR}/${IMAGE_LINK_NAME}.${FLASH_EXT4_BASETYPE}.zst
	ln -sf ${S}/MANIFEST MANIFEST
	ln -sf ${S}/publickey publickey
