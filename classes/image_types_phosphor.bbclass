...
EXT4_RWFS_CMD = "mkfs.ext4 -d ext4 -F ${IMGDEPLOYDIR}/${IMAGE_LINK_NAME}.ext4"
...
do_generate_rwfs_ext4() {
	clean_rwfs ${FLASH_EXT4_OVERLAY_BASETYPE}
	mk_empty_image rwfs.ext4 1024
...
do_generate_ext4_tar() {
	ln -sf ${S}/MANIFEST MANIFEST
	ln -sf ${S}/publickey publickey
	make_image_links ${FLASH_EXT4_OVERLAY_BASETYPE} ${FLASH_EXT4_BASETYPE}
	make_signatures image-u-boot image-kernel image-rofs image-rwfs MANIFEST publickey
