...
SRC_URI = "git://git-amr-2.devtools.intel.com:29418/openbmc-intel-chassis-control.git;protocol=ssh"
SRCREV = "3820945c6e3f50a5e9ee7f0c3ca68e3009c5686e"

S = "${WORKDIR}/git/services/chassis/"

PV = "1.0+git${SRCPV}"

inherit cmake pkgconfig obmc-phosphor-license pythonnative
