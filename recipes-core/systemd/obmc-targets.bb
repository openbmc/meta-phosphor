...
# - diagnostic-mode: The host is collecting debug data
HOST_ACTION_TARGETS = "start startmin stop quiesce reset shutdown crash timeout reboot warm-reboot diagnostic-mode"
